%
% % Select window lengths to loop through
% Lag = 60;
% % Number of PCs
% K = 3;
% % Load FF factors
...
% FF_Size = xlsread('monthly_cap_merged_v4.csv');
% % Collect dates
% Dates = FF(:, 1);
...
% % Load FF portfolios
% Ports = xlsread('monthly_merged_v4.csv');
% % Risk-free rate
% RF = FF(:, end) ./ 100;
% % Clean data
% Ports_Start = Ports./ 100 - RF;
% % Load prices
% load('priceM.mat');
% % Load Returns
% load('retM.mat');
...
%     '10 RESVAR', '10 BETA','10 MOM', '10 STREV','10 IND',...
%     '5x5 Size and BM','5x5 Size and OP','5x5 Size and INV','5x5 Size and MOM','5x5 Size and STREV',...
%     '5x5 Size and LTREV', '5x5 Size and VAR','5x5 Size and NI','5x5 Size and BETA','5x5 Size and AC' };
