...
legend({'Data',strcat('Slope = ',...
    num2str(OLS_Line_NoOrth.beta(2))),'Theory Implied'},'Location','best')
...
legend({'Data',strcat('Slope = ',...
    num2str(IV_Line_NoOrth.beta(2))),'Theory Implied'},'Location','best')
...
legend({'Data',strcat('Slope = ',...
    num2str(OLS_Line_Orth.beta(2))),'Theory Implied'},'Location','best')
...
legend({'Data',strcat('Slope = ',...
    num2str(IV_Line_Orth.beta(2))),'Theory Implied'},'Location','best')
